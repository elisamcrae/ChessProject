...
public class King extends ChessPieceE{
    public King(ChessGame.TeamColor teamColor) {
        super(teamColor, ChessPieceE.PieceType.KING);
    }
    ...
    public Collection<ChessMove> pieceMoves(ChessBoard board, ChessPosition myPosition) {
        ...
        newPos.setRow(myPosition.getRow());
        ChessPositionE newPosB = new ChessPositionE(myPosition.getRow(), myPosition.getColumn() + 1);
        ...
        //down one
        newPos1.setCol(myPosition.getColumn() - 1);
        newPos1.setRow(myPosition.getRow());
        ChessPositionE newPos1B = new ChessPositionE(myPosition.getRow(), myPosition.getColumn() - 1);
        ...
        newPos2.setCol(myPosition.getColumn());

        ChessPositionE newPos2B = new ChessPositionE(myPosition.getRow() + 1, myPosition.getColumn());
        ...
        newPos3.setCol(myPosition.getColumn());

        ChessPositionE newPos3B = new ChessPositionE(myPosition.getRow() - 1, myPosition.getColumn());
        ...
        ChessPositionE newPosB4 = new ChessPositionE(myPosition.getRow() + 1, myPosition.getColumn() + 1);
        ...
        ChessPositionE newPos5B = new ChessPositionE(myPosition.getRow() - 1, myPosition.getColumn() + 1);
        ...
        //diagonal down right
        newPos6.setRow(myPosition.getRow() + 1);
        newPos6.setCol(myPosition.getColumn() - 1);
        ChessPositionE newPos6B = new ChessPositionE(myPosition.getRow() + 1, myPosition.getColumn() - 1);
        ...
        newPos7.setCol(myPosition.getColumn() - 1);
        ChessPositionE newPos7B = new ChessPositionE(myPosition.getRow() - 1, myPosition.getColumn() - 1);
